...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (162007, uint256("0x9327029caf6089c9e73582cee7219363b566dce3496a4ef8c8c49183f8628fe0"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1406291731, // * UNIX timestamp of last checkpoint block
        203165,     // * total number of transactions between genesis and last checkpoint
