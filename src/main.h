...
const int64_t nBlockDiffAdjustV3 = 394000; // block where difficulty adjust V3 starts
const int64_t nBlockDiffAdjustV4 = 395000; // block where difficulty adjust V4 starts
