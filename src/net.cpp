...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Desicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"squealer.in", "180.179.50.63"},
    {"desicoin.org", "dnsseed.desicoin.org"},
    {"tss.org.in", "182.18.175.110"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ltccointools.com", "testnet-seed.ltccointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Desicoin is probably already running."), addrBind.ToString().c_str());
        else
